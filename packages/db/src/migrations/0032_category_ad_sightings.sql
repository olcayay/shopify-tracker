...
CREATE INDEX "idx_cat_ad_sightings_cat_date" ON "category_ad_sightings" USING btree ("category_slug", "seen_date");
CREATE INDEX "idx_cat_ad_sightings_app_date" ON "category_ad_sightings" USING btree ("app_slug", "seen_date");
CREATE UNIQUE INDEX "idx_cat_ad_sightings_unique" ON "category_ad_sightings" USING btree ("app_slug", "category_slug", "seen_date");
