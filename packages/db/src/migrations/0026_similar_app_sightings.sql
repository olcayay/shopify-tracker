...
CREATE INDEX IF NOT EXISTS "idx_similar_sightings_app_date" ON "similar_app_sightings" USING btree ("app_slug", "seen_date");
CREATE INDEX IF NOT EXISTS "idx_similar_sightings_similar_date" ON "similar_app_sightings" USING btree ("similar_app_slug", "seen_date");
CREATE UNIQUE INDEX IF NOT EXISTS "idx_similar_sightings_unique" ON "similar_app_sightings" USING btree ("app_slug", "similar_app_slug", "seen_date");
