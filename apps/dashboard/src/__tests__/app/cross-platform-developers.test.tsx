...
describe("DevelopersPage (cross-platform)", () => {
  ...
  it("shows +N badge when developer has more than 5 app icons", async () => {
    setupFetchMocks({
      developers: [
        {
          id: 3,
    ...
    // 5 icons rendered + "+9" badge (14 total - 5 shown = 9 remaining)
    expect(document.querySelectorAll("img[src*='example.com']")).toHaveLength(5);
