...
import { RotateCcw, Plus, X as XIcon, ExternalLink } from "lucide-react";
...
export default function PreviewPage() {
  ...
  // Editable fields (must be before any conditional returns)
  ...
  // Preview is only available for Shopify
  if (platform !== "shopify") {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        <h2 className="text-xl font-semibold">Preview not available</h2>
        <p className="text-muted-foreground text-center max-w-md">
          The listing preview is only available for Shopify apps.
        </p>
        <a
